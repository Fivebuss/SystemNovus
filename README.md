...
* Possible moons for either Heilia or Novera?
* Use my procedural rings thingy once I get it working
* Optimization, such as downscaling 4k textures to 1k. By far not a priority
* Misc stuff like science defs
* Release sometime in the next century
    * Proper name
    * Core-style restructure
    * Optimize
    * Bugfix
    * Pretty readme/perhaps wiki with screenshots
    * More stuff to do on the planets
* Second star system? I do quite like PDS70 or V1400 centuari

## Requirements for people insane enough to install it, which is no one
